...
st.set_page_config(page_title="Sketch To Code", page_icon=":lower_left_paintbrush:", layout="wide")
...
# Page title
st.markdown("# :blue[Sketch To Code]:lower_left_paintbrush:")
...
model_file_path = "../modelsCustomCNN/models/ED--epoch-92--loss-0.01324.pth" 
img_crop_size = 224
seed = 42
...
if uploaded_file is not None:
    ...
    st.image(image_resized, caption="Your Sketch", width=300)
